...
- [`createSmartEdge`](./create-smart-edge) — preset wrapper
- [`smartEdgePresets`](./smart-edge-presets) — canonical preset configs
- [`getSmartEdgeWaypoints`](./get-smart-edge-waypoints) — multi-segment routing through waypoints
